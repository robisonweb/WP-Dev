                ...
                if(this.headerType==='header-menu-split'){
                        ...
                        _resize=function(){
                                if (self.bodyCl.contains('mobile_menu_active')) {
                                        if ($('.header-bar #site-logo').length == 0) {
                                                $('.themify-logo-menu-item #site-logo').prependTo('.header-bar');
                                        }
                                } else if ($('.themify-logo-menu-item #site-logo').length === 0) {
                                        $('.themify-logo-menu-item').append($('.header-bar #site-logo'));
                                }
                        };
                        _resize();
