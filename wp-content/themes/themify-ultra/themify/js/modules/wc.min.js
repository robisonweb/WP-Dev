...
null,function(){return"undefined"!==typeof window._}))};!0===k&&(c["jquery-blockui"]&&b.LoadAsync(c["jquery-blockui"],function(){h("jquery-blockui")},-1===c["jquery-blockui"].indexOf("ver=",12)?g:!1,null,function(){return void 0!==d.blockUI}),d.fn.wc_product_gallery||"undefined"===typeof wc_single_product_params?delete c["wc-single-product"]:c["wc-single-product"]&&b.LoadAsync(c["wc-single-product"],function(){h("wc-single-product");b.trigger("tf_init_photoswipe")},-1===c["wc-single-product"].indexOf("ver=",
12)?g:!1,null,function(){return void 0!==d.fn.wc_product_gallery}));c["wc-add-to-cart"]?b.LoadAsync(c["wc-add-to-cart"],function(){h("wc-add-to-cart");u()},-1===c["wc-add-to-cart"].indexOf("ver=",12)?g:!1):u();c["js-cookie"]?b.LoadAsync(c["js-cookie"],function(){h("js-cookie");b.LoadAsync(c["wc-cart-fragments"],function(){h("wc-cart-fragments")},-1===c["wc-cart-fragments"].indexOf("ver=",12)?g:!1);!0===k&&f()},-1===c["js-cookie"].indexOf("ver=",12)?g:!1,null,function(){return!!window.Cookies}):f()},
t=function(a,b,d,f){!1===l&&(l=!0,k(a,b,d,f))};b.body.one("added_to_cart removed_from_cart",t).on("click.tf_wc_click",".ajax_add_to_cart,.remove_from_cart_button",function(a){a.preventDefault();a.stopImmediatePropagation();a.target.classList.contains("loading")||(n.push(a.target),a.target.classList.add("loading"));!1===l&&(l=!0,k(a))});p&&p.addEventListener("change",r,{passive:!0,once:!0});delete themify_vars.wc_js["wc-add-to-cart-variation"];delete themify_vars.wc_js.wc_additional_variation_images_script;
