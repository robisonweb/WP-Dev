	...
	<?php endif; ?>
		...
		<span class="chart-html5-circle tf_w tf_h">
			...
			<?php elseif($fields_args['image_feature'] !== ''):?>
				<img style="width:calc(100% - <?php echo $w*2 ?>px);height:calc(100% - <?php echo $w*2 ?>px)" src="<?php echo themify_generateWebp(esc_url($fields_args['image_feature'])) ?>" alt="<?php esc_attr_e($alt)?>"/>
			 <?php endif; ?>
		   </span>
	    </span>
	    <?php if ('' !== $fields_args['link_feature']) : ?>
