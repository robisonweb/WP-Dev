				...
				self::get_tab( array(
					'n' => array(
						'options' => array(
							...
							self::get_text_decoration( array( ' .module-buttons-item a', ' .module-buttons-item a i' ) )
						)
					),
					'h' => array(
						'options' => array(
							self::get_color( array( ' .module-buttons-item a:hover', ' .module-buttons-item a:hover i' ), 'link_color_hover', null, null, '' ),
							self::get_text_decoration( array( ' .module-buttons-item a:hover', ' .module-buttons-item a:hover i' ), 't_d_h', '' )
						)
					)
				) )
			) ),
